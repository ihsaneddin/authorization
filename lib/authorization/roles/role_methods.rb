require "authorization/roles/finders"
...
module Authorization::Roles
  module RoleMethods
    ...
    def has_role?(role_name, resource = nil)
      return has_strict_role?(role_name, resource) if self.class.strict_role and resource and resource != :any
    ...
    def has_cached_role?(role_name, resource = nil)
      return has_strict_cached_role?(role_name, resource) if self.class.strict_role and resource and resource != :any
