Authorization.setup do |config|
  ...
  config.access.setup do |access_config|
    ...
    access_config.can_be_read_by do |current_user, role, context|
      true
    end

    access_config.can_be_created_by do |current_user, role, context|
      true
    end

    access_config.can_be_edited_by do |current_user, role, context|
      true
    end

    access_config.can_be_deleted_by do |current_user, role, context|
      true
    end
  end
